...
public class MainActivity extends AppCompatActivity
    ...
    // non-zero drift.
    //jika nilai pitch dan roll < 0.05 akan dianggap 0 agar tidak banyak pengaruh perubahan
    private static final float VALUE_DRIFT = 0.05f;

    //menambahkan variabel accelometer dan magnetometer
    ...
    public void onSensorChanged(SensorEvent sensorEvent) {
        ...
        boolean rotationOK=SensorManager.getRotationMatrix(rotationMatrix, null, mAccelometerData, mMagnetometerData);
        ...
        mTextSensorPitch.setText(String.format("%1, 2F.pitching"));
